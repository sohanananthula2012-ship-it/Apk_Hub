    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#080b10' }}>
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl p-8" style={{ background: '#0f1419', border: '1px solid rgba(255,255,255,0.08)' }}>
          <h1 className="text-2xl font-bold text-white mb-1 font-display">Create account</h1>
          <p className="text-gray-500 text-sm mb-6">Start distributing your Android apps</p>
          ...
          <form onSubmit={submit} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Jane Developer" required autoComplete="name"
              ...
              <div className="flex flex-col gap-1 mt-2">
                {checks.map(c => (
                  <div key={c.label} className="flex items-center gap-1.5 text-xs"
                    style={{ color: c.ok ? '#00ff88' : '#4b5563' }}>
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            ...
            <Link to="/login" className="font-semibold" style={{ color: '#00ff88' }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
